    ...
    uint16_t color)
{
    ...
    {
        st7789_draw_pixel(i, y, color);
        st7789_draw_pixel(i, y + h - 1, color);
    }

    for (uint16_t i = y; i < y + h; i++)
    {
        st7789_draw_pixel(x, i, color);
        st7789_draw_pixel(x + w - 1, i, color);
    }
}
